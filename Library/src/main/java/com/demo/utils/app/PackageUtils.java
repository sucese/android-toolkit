...
import com.demo.utils.string.StringUtils;
import com.demo.utils.collection.ListUtils;
 ...
 * Date: 16/4/1 上午11:14
 * Function: package utils
 *
 * Modification history:
 * Date                 Author              Version             Description
 * ------------------------------------------------------------------------
 * 16/4/1 上午11:14      guoxiaoxing         1.0
 */
public class PackageUtils {
     ...
     * permission, if you are system com.demo.utils.app.</li>
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        /**
         * if context is system com.demo.utils.app, don't need root permission, but should add <uses-permission
     ...
     * 
     * @param context
     * @param packageName package name of com.demo.utils.app
    ...
    /**
     * uninstall package and clear data of com.demo.utils.app silent by root
     * 
     * @param context
     * @param packageName package name of com.demo.utils.app
     * @return
     ...
     *         <li>if package name exit, but not system com.demo.utils.app, return false</li>
    ...
    /**
     * whether the com.demo.utils.app whost package's name is packageName is on the top of the stack
     * <ul>
     * <strong>Attentions:</strong>
     ...
     * @param context
     * @param packageName
     * @return if params error or task stack is null, return null, otherwise retun whether the com.demo.utils.app is on the top of
     *         stack
     */
    ...
    /**
     * get com.demo.utils.app version code
     * 
     * @param context
     * @return
     */
    ...
    /**
     * Installation return code<br/>
     * the package manager service found that the device didn't have enough storage space to install the com.demo.utils.app.
     */
