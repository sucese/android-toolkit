 ...
 * --------------------------------------------------------------------------
 * 16/4/15 下午5:31      guoxiaoxing          1.0                record utils
 */
public class RecorderUtils {
    ...
    public RecorderUtils(String name) {
        if (mRecorder == null) {
    ...
    public void playingFinish() {
        Log.i("spoort_list", "RecorderUtils 播放结束释放资源");
        if (playState) {
            playState = false;
        }
        mPlayer.release();
    ...
    public boolean stopPlaying() {
        ...
        if (mPlayer != null) {
            ...
            Log.i("spoort_list", "RecorderUtils mPlayer.stop()");
            mPlayer.stop();
            mPlayer.release();
            mPlayer = null;
            playState = false;
            ...
            Log.i("spoort_list", "RecorderUtils mPlayer.stop() is null");
            return false;
        }
    }
    //当文件播放结束后调用此方法
    ...
    ////				playState = false;
    ////			}
    //			Log.i("spoort_list", "RecorderUtils 播放结束");
    //			mPlayer.release();
    //			mPlayer = null;
    //		}
    //	};
